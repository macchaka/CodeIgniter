...
class CI_Cart {
	...
	var $product_name_rules	= 'ˆê-êž‚Ÿ-‚ñƒ@-ƒ”[‚-‚š‚`-‚y‚O-‚X\.\:\-_ a-z0-9'; // Japanese, alpha-numeric, dashes, underscores, colons or periods
	...
	function _insert($items = array())
	{
		...
		$items['price'] = trim(preg_replace('/([^0-9_.])/i', '', $items['price']));
		// Trim any leading zeros
